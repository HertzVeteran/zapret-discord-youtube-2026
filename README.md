...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/HertzVeteran/">HertzVeteran</a><a href="https://github.com/HertzVeteran/zapret-discord-youtube">/zapret-discord-youtube</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />

**NEW**: Ускорение Telegram Desktop - https://github.com/HertzVeteran/tg-ws-proxy  
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/HertzVeteran/zapret-discord-youtube/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/HertzVeteran/zapret-discord-youtube/issues/522)
...
#### Работа не гарантирована. Если не помогло - используйте [Desktop версию](https://github.com/telegramdesktop/tdesktop/releases) с [локальным прокси](https://github.com/HertzVeteran/tg-ws-proxy) или любыми публичными.
...
- См. [#765](https://github.com/HertzVeteran/zapret-discord-youtube/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/HertzVeteran/zapret-discord-youtube/releases) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/HertzVeteran/zapret-discord-youtube/discussions/251)
...
- См. также [#252](https://github.com/HertzVeteran/zapret-discord-youtube/discussions/252)

### Не работает <img src="https://cdn-icons-png.flaticon.com/128/5968/5968804.png" height=18 /> Telegram

- Используйте программу [tg-ws-proxy](https://github.com/HertzVeteran/tg-ws-proxy)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/HertzVeteran/zapret-discord-youtube/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/HertzVeteran/zapret-discord-youtube/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/HertzVeteran/zapret-discord-youtube/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

[![Contributors](https://contrib.rocks/image?repo=HertzVeteran/zapret-discord-youtube)](https://github.com/HertzVeteran/zapret-discord-youtube/graphs/contributors)
